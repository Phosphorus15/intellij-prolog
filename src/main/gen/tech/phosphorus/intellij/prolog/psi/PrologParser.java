...
public class PrologParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // ref_predicate_id parameter_list?
  public static boolean common_predicate(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "common_predicate")) return false;
    if (!nextTokenIs(b, CONST_ID)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = ref_predicate_id(b, l + 1);
    r = r && common_predicate_1(b, l + 1);
    exit_section_(b, m, COMMON_PREDICATE, r);
    return r;
  }

  // parameter_list?
  private static boolean common_predicate_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "common_predicate_1")) return false;
    parameter_list(b, l + 1);
    return true;
  }

  /* ********************************************************** */
  // common_predicate | ident | literal | list_constructor | '_'
  ...
  /* ********************************************************** */
  // const_id
  public static boolean ref_predicate_id(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "ref_predicate_id")) return false;
    if (!nextTokenIs(b, CONST_ID)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, CONST_ID);
    exit_section_(b, m, REF_PREDICATE_ID, r);
    return r;
  }
  ...
  /* ********************************************************** */
  // !<<eof>> (toplevel_expr | trailing_expr) '.'
  ...
  /* ********************************************************** */
  // expr_head ((':-' | '-->') expr_body)?
  public static boolean toplevel_expr(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "toplevel_expr")) return false;
    if (!nextTokenIs(b, CONST_ID)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = expr_head(b, l + 1);
    r = r && toplevel_expr_1(b, l + 1);
    exit_section_(b, m, TOPLEVEL_EXPR, r);
    return r;
  }

  // ((':-' | '-->') expr_body)?
  private static boolean toplevel_expr_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "toplevel_expr_1")) return false;
    toplevel_expr_1_0(b, l + 1);
    return true;
  }

  // (':-' | '-->') expr_body
  private static boolean toplevel_expr_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "toplevel_expr_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = toplevel_expr_1_0_0(b, l + 1);
    r = r && expr_body(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // ':-' | '-->'
  private static boolean toplevel_expr_1_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "toplevel_expr_1_0_0")) return false;
    boolean r;
  ...
  /* ********************************************************** */
  // ':-' expr_body
  public static boolean trailing_expr(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "trailing_expr")) return false;
    if (!nextTokenIs(b, UNIFY)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, UNIFY);
    r = r && expr_body(b, l + 1);
    exit_section_(b, m, TRAILING_EXPR, r);
    return r;
  }
